 ...
 *               _____                                             _____
 *           NC | · · | GND                                    5V | · · | GND
 *        RESET | · · | PB10(SD_DETECT)             (LCD_D7)  PD1 | · · | PD0  (LCD_D6)
 *   (MOSI) PA7 | · · | PC7(BTN_EN2)               (LCD_D5)  PC12 | · · | PC10  (LCD_D4)
 *  (SD_SS) PA4 | · · | PC6(BTN_EN1)                 (LCD_RS) PD2 | · · | PC11 (LCD_EN)
 *    (SCK) PA5 | · · | PA6 (MISO)                 (BTN_ENC)  PA8 | · · | PC9  (BEEPER)
 *               ￣￣                                               ￣￣
 *               EXP2                                              EXP1
 */
...
//
  ...
  #define BTN_ENC          PA8
    ...
    #if ENABLED(FYSETC_MINI_12864) // TODO
