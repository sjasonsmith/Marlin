...
void MarlinSettings::postprocess() {
  xyze_pos_t oldpos = motion.current_position_rw();
  ...
  // and init stepper.count[], planner.position[] with motion.current_position_rw()
  planner.refresh_positioning();

  // Various factors can change the current position
  if (oldpos != motion.current_position_rw())
