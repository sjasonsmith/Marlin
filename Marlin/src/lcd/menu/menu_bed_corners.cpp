 ...
 */
  ...
  void _lcd_test_corners() {
    ...
    do {
      ...
      switch (bed_corner) {
        case 0: new_pos   = plf;   break; // copy xy
        case 1: new_pos.x = prb.x; break;
        case 2: new_pos.y = prb.y; break;
        case 3: new_pos.x = plf.x; break;
        #if ENABLED(LEVEL_CENTER_TOO)
          case 4: new_pos.set(X_CENTER - probe.offset_xy.x, Y_CENTER - probe.offset_xy.y); break;
        #endif
      }
      do_blocking_move_to_xy(new_pos, manual_feedrate_mm_s.x);           // Goto corner
