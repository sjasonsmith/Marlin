...
////////////////////////////////////////////
   ...
   * has a space for it, then add a linear move to motion.current_position_rw() the planner.
   *
   * If any manual move needs to be interrupted, make sure to force a manual move
   * by setting manual_move.start_time to millis() after updating motion.current_position_rw().
   *
   * To post a manual move:
   *   - Update motion.current_position_rw() to the new place you want to go.
  ...
  //
  // Tell ui.update() to start a move to motion.current_position_rw() after a short delay.
  //
