...
FORCE_INLINE static void HAL_timer_set_compare(const uint8_t timer_num, const hal_timer_t compare) {
  switch (timer_num) {
    case 0: STEP_TIMER_PTR->MR[0] = compare; break; // Stepper Timer Match Register 0
    case 1: TEMP_TIMER_PTR->MR[0] = compare; break; //    Temp Timer Match Register 0
  }
}

FORCE_INLINE static hal_timer_t HAL_timer_get_compare(const uint8_t timer_num) {
  switch (timer_num) {
    case 0: return STEP_TIMER_PTR->MR[0]; // Stepper Timer Match Register 0
    case 1: return TEMP_TIMER_PTR->MR[0]; //    Temp Timer Match Register 0
  }
  return 0;
}
