...
#define STRING_CONFIG_H_AUTHOR "(sjasonsmith, Ender Something)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 with MicroSwiss hotend, calibrated for 250C
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -16, -2.17 }
